...
describe('policyService ', async () => {
    ...
    it('isUserIdOrGroupIdAllowed', async () => {
        ...
        const ipintel = new IpIntelligenceService(configService, redisService, inputService);
    ...
    /*
        it('isIpIntelligenceBlackListContains', async () => {
            ...
            rule.profile.ipIntelligence = { isCrawler: false, isHosting: false, isProxy: false, isWhiteList: false, blackLists: [], whiteLists: [] };
        ...
        it('isIpIntelligenceAllowed', async () => {
            ...
            rule.profile.ipIntelligence = { isBlackList: false, isCrawler: false, isHosting: false, isProxy: false, blackLists: [], whiteLists: [] };
            ...
            rule.profile.ipIntelligence = { isWhiteList: false, isCrawler: false, isHosting: false, isProxy: false, blackLists: [], whiteLists: [] };
            result = await policyService.isIpIntelligenceAllowed(rule, {} as any, '1.2.3.4');
            expect(result).to.be.false;
        ...
        it('userNetworks', async () => {
            ...
            configService.config.ipIntelligence.blackLists.push({ id: '123', insertDate: '', val: '0.0.0.0/0' });
            result = await policyService.userNetworks({ id: 'someid', groupIds: ['somegroupid'] } as any, session, session.ip);
            expect(result.length).to.be.equal(1);
