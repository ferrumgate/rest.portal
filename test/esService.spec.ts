...
describe.skip('esService ', async () => {
    ...
    it('reConfigure', async () => {
        ...
        await es.reConfigure(esHost, esUser, esPass);
        isError = false;
        try {
            const data = await es.activityCreateIndexIfNotExits(activity1);
            await es.activitySave([data]);
    ...
    it('reConfigure2 reconnect to same host', async () => {
        ...
        await es.reConfigure(esHost, user, pass);
        isError = false;
        try {
            const data = await es.activityCreateIndexIfNotExits(activity1);
            await es.activitySave([data]);
    ...
    function createSampleData11() {
        let list: FqdnIntelligenceList = {
            id: Util.randomNumberString(), name: "test",
            insertDate: new Date().toISOString(),
            updateDate: new Date().toISOString(),

        }
        let list1Item1: FqdnIntelligenceListItem = {
            insertDate: new Date().toISOString(),
            id: list.id, page: 5,
            fqdn: 'yahoo.com'
        }
        let list1Item2: FqdnIntelligenceListItem = {
            insertDate: new Date().toISOString(),
            id: list.id, page: 5,
            fqdn: 'amazon.com'
        }
        let list1Item3: FqdnIntelligenceListItem = {
            insertDate: new Date().toISOString(),
            id: list.id, page: 6,
            fqdn: 'amazon.com'
        }

        let list2: FqdnIntelligenceList = {
            id: Util.randomNumberString(), name: "test",
            insertDate: new Date().toISOString(),
            updateDate: new Date().toISOString(),

        }
        let list2Item1: FqdnIntelligenceListItem = {
            insertDate: new Date().toISOString(),
            id: list2.id, page: 5,
            fqdn: 'www.ferrumgate.com'
        }
        let list2Item2: FqdnIntelligenceListItem = {
            insertDate: new Date().toISOString(),
            id: list2.id, page: 5,
            fqdn: 'ferrumgate.com'
        }
        let list2Item3: FqdnIntelligenceListItem = {
            insertDate: new Date().toISOString(),
            id: list2.id, page: 6,
            fqdn: 'google.com'
        }
    ...
    it('fqdnIntellligenceListCreateIndexIfNotExits', async () => {
        const es = new ESService(config, host, user, pass, '1s');
        const {
            list, list1Item1, list1Item2, list1Item3,
            list2, list2Item1, list2Item2, list2Item3 } = createSampleData11();
        await es.fqdnIntelligenceListCreateIndexIfNotExits(list1Item1);
        await es.fqdnIntelligenceListCreateIndexIfNotExits(list2Item1);
        const indexes = await es.getAllIndexes();
        expect(indexes.includes(`fqdn-intelligence-list-${list.id}`));
        expect(indexes.includes(`fqdn-intelligence-list-${list2.id}`));
    ...
    it('fqdnIntelligenceListSave', async () => {
        ...
        const {
            list, list1Item1, list1Item2, list1Item3,
            list2, list2Item1, list2Item2, list2Item3 } = createSampleData11();
        const data = await es.fqdnIntelligenceListCreateIndexIfNotExits(list1Item1);
    ...
    it('fqdnIntelligenceListSearch', async () => {
        ...
        const {
            ...
            list2, list2Item1, list2Item2, list2Item3 } = createSampleData11();
        for (let item of [list1Item1, list1Item2, list1Item3, list2Item1, list2Item2, list2Item3]) {
            const data = await es.fqdnIntelligenceListCreateIndexIfNotExits(item);
            await es.fqdnIntelligenceListItemSave([data]);
        }
        let tryCounter = 10;
        let listIds;
        while (tryCounter--) {
            listIds = await es.searchFqdnIntelligenceList({ searchFqdn: 'amazon.com' });
            if (listIds.items.length > 0)
                break;
            await Util.sleep(1000);
        }
    ...
    it('deleteFqdnIntelligenceList', async () => {
        ...
        await es.deleteFqdnIntelligenceList({ page: 5, id: list.id });
        await Util.sleep(1000);

        let listIds = await es.searchFqdnIntelligenceList({ id: list.id, searchFqdn: 'amazon2.com' });
        expect(listIds.items.length).to.equal(0);

        //delete all idnex
        await es.deleteFqdnIntelligenceList({ id: list.id });
        await Util.sleep(1000);
    ...
    it('scrollFqdnIntelligenceList', async () => {
        ...
        const items: IpIntelligenceListItem[] = [];
        await es.scrollFqdnIntelligenceList({ id: list.id }, () => true, async (el: any) => {
            items.push(el);
        })
