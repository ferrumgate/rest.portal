...
describe('userApiAuthenticated', async () => {
    ...
    before(async () => {
        ...
        await appService.configService.setSSLCertificate({ privateKey: fs.readFileSync('./ferrumgate.com.key').toString(), publicKey: fs.readFileSync('./ferrumgate.com.crt').toString() });
    })
