...
describe('networkApi', async () => {
    ...
    it('check authoration as admin role', async () => {
        ...
        await appService.configService.setNetwork(network);
    ...
    it('GET /network/search will return 200', async () => {
        ...
        await appService.configService.setNetwork(network2);
        ...
        await appService.configService.setNetwork(network3);
        ...
        expect(response.body[0]).to.deep.equal(network);
        ...
        expect(response.body).exist;
        expect(response.body.length).to.equal(2);
        expect(response.body[0]).to.deep.equal(network2);
