...
describe.skip('templateService', async () => {
    ...
    it('createEmailConfirmation', async () => {
        ...
        const template = await templateService.createEmailConfirmation('hamza', 'https://portal.ferrumgate.com/user/confirm/email/9sTVrjfbhA0iI15qVi8a7HXIXDtUg22VHTJt3Z9s8XXlqAH5', logopath);
    ...
    it('createForgotPassword', async () => {
        ...
        const templateService = new TemplateService(configService);
        const logopath = (await configService.getLogo()).defaultPath || 'logo.png';
        const template = await templateService.createForgotPassword('hamza', 'https://portal.ferrumgate.com/user/confirm/email/9sTVrjfbhA0iI15qVi8a7HXIXDtUg22VHTJt3Z9s8XXlqAH5', logopath);
